...
export default function Home() {
  ...
  return (
    <html lang='en' class='scroll-smooth'>
      <div className="flex flex-col h-full w-full bg-gradient-to-t from-purple-950 via-neutral-800 to-black min-h-screen gap-2 overflow-x-hidden">
        
        <Header></Header>

          <section id="Home" className="flex flex-col w-full pb-10 max-w-7xl py-60 mx-auto px-6 md:px-20 md:py-60 lg:py-60 scroll-mt-24" data-aos='fade-up' data-aos-delay='0'>
          ...
          <AboutMe data-aos='fade-up' data-aos-delay='0'></AboutMe>

          <Projects data-aos='fade-up' data-aos-delay='0'></Projects>

          <Contacts data-aos='fade-up' data-aos-delay='0'></Contacts>
