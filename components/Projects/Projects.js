       ...
       <div 
        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
                ...
                <Card name='Dashboard Python' desc='Painel interativo para análise de dados e monitoramento de KPIs, transformando bases complexas em visualizações estratégicas e intuitivas.' imagem='/imagens/Dashboard.png' link="https://github.com/DaviAlves06/Dashboard-Python" data-aos='fade-up' data-aos-delay='0'></Card>
