...
const Projects = () => {
    return(
        ...
        <section 
            id="Projetos" 
            className="flex flex-col w-full py-24 px-6 md:px-20 max-w-7xl mx-auto"
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
                ...
                <Card name='Jogo do Número Secreto' desc='Jogo de adivinhação que demonstra o domínio de JavaScript Vanilla e manipulação da DOM.' imagem='/imagens/NumeroSecreto.png' link="https://github.com/DaviAlves06/Jogo-do-Numero-Secreto"></Card>
                <Card name='Organo: Gestão de Times' desc='Aplicação construída em React que permite a criação e visualização dinâmica de times e colaboradores. Foco em componentização e estados.' imagem='/imagens/Organo.png' link="https://github.com/DaviAlves06/Organo"></Card>
